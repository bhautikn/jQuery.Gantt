...
(function($, undefined) {
    ...
    $.fn.gantt = function(options) {
        ...
        var core = {
            ...
            createProgressBar: function(label, desc, classNames, progress, dataObj) {
                label = label || "";
                var bar = $('<div class="bar"><div class="progress-bar" style="width:' + progress + '%;"></div><div class="fn-label above-progress">' + label + '</div></div>')
                        ...
                        $.each(entry.values, function(j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                case "hours":
                                    ...
                                    _bar = core.createProgressBar(day.label, day.desc, day.customClass, day.progress, day.dataObj);
